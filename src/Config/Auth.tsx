/*
Notes:
-postLogoutRedirectUri is for local testing, to set in production go to front channel logout url in Azure portal
-there are more options in the link shown below
-
*/
...
export const msalConfig: Configuration = {
    auth: {
        ...
        redirectUri: 'http://localhost:5173/Home', // Points to window.location.origin. You must register this URI on Microsoft Entra admin center/App Registration.
